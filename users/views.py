...
def github_login(request):
    ...
    redirect_uri = f"{os.environ.get("HOST", 'http://127.0.0.1:8000')}/users/login/github/callback"
    return redirect(
...
def kakao_login(request):
    ...
    redirect_uri = f"{os.environ.get("HOST", 'http://127.0.0.1:8000')}/users/login/kakao/callback"
    return redirect(
